...
public class Van : MonoBehaviour
{
    ...
    public struct Stats
    {
        ...
        [Tooltip("How quickly the van reaches top speed.")]
        public float Acceleration;

        [Min(0.001f), Tooltip("Top speed attainable when moving backward.")]
        public float ReverseSpeed;

        [Tooltip("How quickly the van reaches top speed, when moving backward.")]
        public float ReverseAcceleration;

        [Tooltip("How quickly the van starts accelerating from 0. A higher number means it accelerates faster sooner.")]
        [Range(0.2f, 1)]
        public float AccelerationCurve;

        [Tooltip("How quickly the van slows down when the brake is applied.")]
        public float Braking;

        [Tooltip("How quickly the van will reach a full stop when no inputs are made.")]
        ...
        [Tooltip("How tightly the van can turn left or right.")]
        public float Steer;

        [Tooltip("Additional gravity for when the van is in the air.")]
    ...
    public Van.Stats baseStats = new Van.Stats
    {
        TopSpeed            = 10f,
        Acceleration        = 5f,
    ...
    void MoveVehicle(bool accelerate, bool brake, float turnInput)
    {
        ...
        if ( audioPlayer.hasEnginSoundEnded)
        {
